...
program
  ...
  .description(
    `创建页面以及一系列相关文件，\n 
    eg：cli_admin createPart 3dm_team_switch_scheduling --table 3dm_team_switch_scheduling --enum_connect team/switch/scheduling --router_path lead-class；\n 
    支持除createPart以外的参数为空的命令，如：cli_admin createPart 3dm_team_switch_scheduling，\n 
    默认值如下--router_path = test，--table = 3dm_team_switch_scheduling，--enum_connect = team/switch/scheduling， 请注意修改对应的路径。\n`
  )
